...
export default function HeroAbout() {
  return (
    <section className="bg-[#0B0B0B] mt-30 text-[#E6D8C3]">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        {/* ABOUT BUTTON */}
        <div className="flex items-center gap-4 mt-10 text-[#D6C1A3]">
          <div className="
            w-12 h-12
            rounded-full
        ...
        {/* LONG ABOUT TEXT (LEFT-ALIGNED, CENTERED BLOCK) */}
        <div className="mt-14 max-w-3xl text-left">
          <p
            className={`
              ${inter.className}
              text-[#A89274]
